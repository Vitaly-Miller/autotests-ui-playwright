...
with sync_playwright() as playwright:                       # Создаем объект playwright = sync_playwright() (инициализация)
    ...
    # Email input field
    email_input_field_locator = page.get_by_label('Email')                # ㉧ LOCATOR
    email_input_field_locator.click()                                     # v.1 ▶ ACTION - click по объекту
    email_input_field_locator.focus()                                     # v.2 ▶ ACTION - Фокус на объекте
